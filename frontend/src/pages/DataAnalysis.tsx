...
import { BarChartOutlined, ComparisonOutlined } from '@ant-design/icons';
import ReactECharts from 'echarts-for-react';
import { apiService } from '@/services/api';
import type { CollectionList, SQLExecutionRecord, PlanDetail, ComparisonData } from '@/types';
...
const DataAnalysis: React.FC = () => {
  ...
  const getComparisonChartOption = () => {
    ...
    const planNames = plans.map((p, index) => `计划${index + 1}`);
